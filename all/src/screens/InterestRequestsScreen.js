...
//   const { interests = [], updateInterestStatus, loadCurrentUserData, currentUser } =
//     useMatrimony();
...
export default function InterestRequestsScreen({ navigation }) {
  ...
  useFocusEffect(
    useCallback(() => {
      if (typeof loadCurrentUserData === "function" && currentUserId) {
        loadCurrentUserData(currentUserId);
      }
    }, [currentUserId, loadCurrentUserData])
  );
  ...
  let visibleInterests = acceptedInterests;
  if (activeTab === "Incoming") {
    visibleInterests = incomingInterests;
  } else if (activeTab === "Sent") {
    visibleInterests = sentInterests;
  }
