...
const proofFields = [
  ...
  {
    key: "maritalProof",
    proofType: "marital-status-proof",
    label: "Marital Status Proof",
    helperText: "Upload relevant marital status proof as image or PDF.",
  },
];
      ...
      >
        ...
        >
          ...
          <Text style={styles.note}>
            Submit correct details and upload address, education, job/income, and marital proofs as image or PDF. Admin will review the same uploaded files from any device.
          </Text>
          ...
          <FormInput
            ...
            onChangeText={(text) => updateField("familyContact", text)}
