      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.heroCard}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.heroText}>
              User profile submit chesthe admin ki request vastundi. Approve
              chesthe user ki notification vellutundi.
            </Text>
          </View>
        </View>
        ...
        >
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.actionText}>
              Pending bride/groom profiles approve or reject cheyyandi.
            </Text>
          </View>
        ...
        >
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.actionText}>
              User submissions and admin alerts ikkada chudandi.
            </Text>
          </View>
        ...
        >
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.actionText}>
              Registered bride and groom profiles chudandi.
            </Text>
          </View>
