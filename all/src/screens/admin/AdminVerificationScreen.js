  ...
  const handleApprove = async (request) => {
    ...
    if (result?.success) {
      Alert.alert(
        ...
        `${request.profileName} verification approved. User ki notification vellindi.`
      );
    }
  };
  ...
  const handleReject = async (request) => {
    ...
    if (result?.success) {
      Alert.alert(
        ...
        `${request.profileName} verification rejected. User ki notification vellindi.`
      );
    }
  };
      ...
      >
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text style={styles.headerSubtitle}>
            User documents check chesi approve/reject cheyyandi
          </Text>
        </View>
      </LinearGradient>
        ...
        {sortedRequests.length === 0 ? (
          <View style={styles.emptyCard}>
            ...
            <Text style={styles.emptyText}>
              User background verification submit chesthe request ikkada
              kanipistundi.
            </Text>
          </View>
        ) : (
